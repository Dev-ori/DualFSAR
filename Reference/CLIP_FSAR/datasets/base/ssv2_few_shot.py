...
sys.path.append("Reference/CLIP_FSAR")
...
sys.path.append("/home/cho092871/Desktop/Networks/DualFSAR")

# from datasets.build import dataset_register
from Reference.CLIP_FSAR.utils.config import Config
import yaml
import utils.checkpoint as ckp

class ConfigFewshot(Config):
    def __init__(self, cfg, load=True, cfg_dict=None, cfg_level=None):
        self.args = cfg
        self.args.cfg_file = cfg.cfg_dataset
        self.args.opts = None
...
#     config = ConfigFewshot(cfg)
#     dataset = Ssv2_few_shot(cfg=config, split=mode)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg_dataset', type=str, default="/home/cho092871/Desktop/Networks/DualFSAR/Reference/CLIP_FSAR/configs/projects/CLIPFSAR/hmdb51/CLIPFSAR_HMDB51_5shot_v1.yaml")
    args = parser.parse_args()
    config = ConfigFewshot(args)
    dataset = Ssv2_few_shot(cfg=config, split='train')
